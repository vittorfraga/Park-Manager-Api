...
import com.vittorfraga.estacionamentoapi.domain.reports.HourlyCount;
import com.vittorfraga.estacionamentoapi.domain.reports.ReportsPerHour;
...
public class GetHourlySummaryDetailsUseCase extends UseCase<ReportsRequest, DetailedReport> {
    ...
    public DetailedReport execute(ReportsRequest request) {
        ...
        ReportsPerHour reportsPerHour = new ReportsPerHour(entriesPerHour, exitsPerHour);
        return new DetailedReport(description, hourFormat, formattedDate, reportsPerHour);
    }
